...
console.log(add(rat1, rat2)); // 25/6
console.log(sub(rat2, rat1)); // 17/6
console.log(mul(rat1, rat2)); // 14/6
console.log(div(rat1, rat2)); // 4/21
console.log(toString(add(rat1, rat2)));
